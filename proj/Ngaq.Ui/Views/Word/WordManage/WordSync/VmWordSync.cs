...
public partial class VmWordSync: ViewModelBase{
	...
	public VmWordSync(
		...
		if(Cfg is not null){
			PathExport = Cfg.Get(ItemsAppCfg.Word.WordsPackExportPath)??"";
			PathImport = Cfg.Get(ItemsAppCfg.Word.WordsPackImportPath)??"";
		}
	...
	public str PathExport{
		...
		set{
			...
			Cfg?.Set(ItemsAppCfg.Word.WordsPackExportPath, value);
		}
	}
	...
	public str PathImport{
		...
		set{
			...
			Cfg?.Set(ItemsAppCfg.Word.WordsPackImportPath, value);
		}
	}
