...
const a: TI18nKv = {
	View: {
		Common: {
			...
			AddWords: "Add Words",
			WordsLibBackupEtSync: "Backup & Sync",
			Start: "Start",
			Save: "Save",
			Reset: "Reset",
			Clear: "Clear",
			...
			Lang: "Language",
			StoredAt: "Stored At",
			Biz_CreatedAt: "Business Created At",
			Biz_UpdatedAt: "Business Updated At",
...
• Other actions:
	...
	- Save your progress periodically to avoid data loss.`,
			...
			DictionaryLookupHotkeyModifiers_: "Dictionary Lookup Hotkey Modifiers",
			...
			SearchUserWords: "Search User Words",
			SelectDictionarySrcLang: "Select Dictionary Source Language",
			SelectDictionaryTgtLang: "Select Dictionary Target Language",
			InputNewWordToSearch: "Input new word to search",
			StudyPlanHelpTitle_: "Study Plan Help Title",
			StudyPlanHelpText_: `The study plan determines "which words to memorize" and "which words to memorize first".

	Component description:
	- Study Plan: Combines various components into a complete strategy
	- Pre-filter: Determines which words to filter from the word library for memorization
	- Weight Calculator: Determines the sorting rules for words
	- Weight Parameters: Adjust the specific parameters used by the sorting algorithm

	Advanced extension features:
	Refer to the weight algorithm plugin online documentation`,
			NormLangManage: "Norm Lang Manage",
			EnglishName: "English Name",
			SaveToUserWordLibrary: "Save to User Word Library",
			ChooseAnotherStudyPlan: "Choose Another Study Plan",
			DictionaryUsageGuide_: `Dictionary content is generated by AI large models, which may make mistakes.
	Click the favorite button to save the entry to your user word library.`,
			InputUserLangNameToSearch: "Input User Lang Name to Search",
			InputLangNameOrCode: "Input Lang Name or Code"
		}
	},
	Error: {
		Common: {
